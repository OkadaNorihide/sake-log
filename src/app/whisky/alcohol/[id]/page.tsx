    ...
    <div className="relative min-h-screen text-white">
      ...
      <div className="relative z-10 p-6 max-w-2xl mx-auto space-y-6">
        <header className="flex items-center justify-between">
          ...
          <Link href="/whisky" className="text-sm underline text-white/80">一覧へ戻る</Link>
        </header>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex gap-3">
              <Link href={`/whisky/bottle/${encodeURIComponent(review.name)}`} className="w-1/3 rounded-lg px-4 py-2 text-center bg-white text-black text-sm font-medium">
                銘柄ページへ
              </Link>
